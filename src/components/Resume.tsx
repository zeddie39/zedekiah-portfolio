        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-white font-semibold text-lg">BSc. Computer Science</h4>
                <p className="text-purple-400 font-medium">Kisii University</p>
                <p className="text-gray-400">2022 - 2026 (Expected)</p>
                <p className="text-gray-300 mt-2">Currently on Industrial Attachment</p>
              </div>
              <div>
                <h4 className="text-white font-semibold text-lg">KCSE Certificate</h4>
                <p className="text-purple-400 font-medium">High School</p>
                <p className="text-gray-400">2022 - Grade B-</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-white font-semibold text-lg">Co-founder & CTO</h4>
                <p className="text-blue-400 font-medium">Ztech Clinic (Zedekiah Tech Clinic)</p>
                <p className="text-gray-400">Dec 2024 - Present</p>
                <ul className="text-gray-300 mt-2 space-y-1 text-sm">
                  <li>• Full-stack development with Python & Django</li>
                  <li>• AI-powered support system implementation</li>
                  <li>• Microservices architecture design</li>
                </ul>
              </div>
              <div>
                <h4 className="text-white font-semibold text-lg">Freelance Developer</h4>
                <p className="text-blue-400 font-medium">Self-Employed</p>
                <p className="text-gray-400">2023 - Present</p>
                <ul className="text-gray-300 mt-2 space-y-1 text-sm">
                  <li>• Web development projects</li>
                  <li>• IoT and robotics solutions</li>
